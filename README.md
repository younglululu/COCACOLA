...
####<i class="icon-cog"> Compile lib for Perl

```c++
$ cd UltraAlignFreeWrapper_perl/
$ swig -c++ -perl -o ultraAlignFree_wrap.cpp ultraAlignFree_wrap.i
$ g++ -fPIC -c ultraAlignFree.cpp
$ g++ -fPIC -c ultraAlignFree_wrap.cpp -I/auto/usc/perl/5.20.0/lib/5.20.0/x86_64-linux-thread-multi/CORE
$ g++ -shared ultraAlignFree.o ultraAlignFree_wrap.o -o ultraAlignFree_wrap.so
